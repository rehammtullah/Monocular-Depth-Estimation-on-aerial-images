...
def main():
    ...
    data_loader = aerial_raw_loader(args.dataset_dir, img_height=args.img_height, img_width=args.img_width, seq_length=args.seq_length, frame_offset=args.frame_offset)
