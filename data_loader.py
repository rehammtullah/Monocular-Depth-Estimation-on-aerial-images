...
class DataLoader(object):
    ...
    def load_train_batch(self):
        ...
        print("################################################################################################################image_paths_queue",image_paths_queue)
    ...
    def data_augmentation(self, im, intrinsics, out_h, out_w, num_source):
        ...
        with tf.device('/gpu:0'): #edited skd
    ...
    def format_file_list(self, data_root, split):
        ...
        cam_file_list = [os.path.join(data_root, subfolders[i], frame_ids[i] + '_cam.txt') for i in range(len(frames))]	
        print(cam_file_list)
        all_list = {}
